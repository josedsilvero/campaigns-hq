...
<div class="row justify-content-center mt-3">
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('campaign_notes.store') }}" method="post">
                    @csrf

                    <div class="mb-3 row">
                        <label for="campaign_id" class="col-md-4 col-form-label text-md-end text-start">campaign_id</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('campaign_id') is-invalid @enderror" id="campaign_id" name="campaign_id" value="{{ old('campaign_id') }}">
                            @error('campaign_id')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('cpa') is-invalid @enderror" id="cpa" name="cpa" value="{{ old('cpa') }}">
                            @error('cpa')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('budget') is-invalid @enderror" id="budget" name="budget" value="{{ old('budget') }}">
                            @error('budget')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Add campaign_note">
                    </div>
